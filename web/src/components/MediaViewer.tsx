...
import { X, ChevronLeft, ChevronRight, Download, Volume2, VolumeX, Play, Pause, Maximize, ExternalLink } from 'lucide-react';
...
const MediaViewer: React.FC<MediaViewerProps> = ({
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            const video = document.querySelector('.media-viewer-video') as HTMLVideoElement;
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            if (contentDisposition) {
                ...
                const extension = currentMedia.mediaType === 'video' ? '.mp4' :
                    currentMedia.mimeType?.includes('png') ? '.png' :
                        currentMedia.mimeType?.includes('gif') ? '.gif' : '.jpg';
    ...
    const VideoControls = ({ className = "custom-video-controls" }: { className?: string }) => (
                            ...
                            >
                                <video
                                    ...
                                    onLoadedMetadata={(e) => {
                                        ...
                                        const availableHeight = viewportHeight * 0.90 - 140;
                        ...
                        <div className="flex justify-center gap-3 overflow-x-auto pb-2">
                            {media.map((item, index) => (
                                <button
                                    ...
                                    className={`flex-shrink-0 w-16 h-16 rounded-xl overflow-hidden border-2 transition-all duration-200 ${index === currentIndex
